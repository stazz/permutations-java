 ...
 */
public class ShortPermutationGenerator extends AbstractPermutationGenerator<short[]>
{
    public static class ShortArrayInfo
        implements ArrayInfo
    {
        private final short[] _array;
        private final int[] _multiplicities;

        public ShortArrayInfo( short[] array )
        {
            short[] copy = Arrays.copyOf( array, array.length );
            Arrays.sort( copy );
            this._array = copy;
    ...
    public ShortPermutationGenerator( ShortArrayInfo array )
    {
        super( array );
